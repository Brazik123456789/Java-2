...
public class Animal implements Competitor {
    ...
    public void infoName() {
        System.out.println(this.type + " " + this.name + " макс дист бега: " + this.maxRunDistance + " макс высота прыжка: " + this.maxJumpHeight + " макс дист заплыва: " + this.maxSwimDistance);
    }
}